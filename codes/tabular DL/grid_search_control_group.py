...
if __name__ == "__main__":
    ...
    # directory setup
    test_dir_name = "tuned_control_AD_g0"
    ...
    target_dir =   f"output/{datasets[0]}/{models_path_name[0]}/{test_dir_name}"
    original_dir = f"output/{datasets[0]}/{models_path_name[0]}/{original_dir_name}"
    # training model selection
    models_used = models_origin_or_MHE[4]
